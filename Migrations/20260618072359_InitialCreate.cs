        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Climate = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Excludes = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_hotel_bookings_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_hotel_bookings_payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "payments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_hotel_bookings_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tour_bookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tour_bookings_TourSchedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "TourSchedules",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_tour_bookings_Tours_TourId",
                        column: x => x.TourId,
                        principalTable: "Tours",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tour_bookings_payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "payments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_tour_bookings_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_hotel_bookings_BookingCode",
                table: "hotel_bookings",
                column: "BookingCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_hotel_bookings_PaymentId",
                table: "hotel_bookings",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_hotel_bookings_RoomId",
                table: "hotel_bookings",
                column: "RoomId");

            migrationBuilder.CreateIndex(
                name: "IX_hotel_bookings_RoomId_CheckIn_CheckOut",
                table: "hotel_bookings",
                columns: new[] { "RoomId", "CheckIn", "CheckOut" });

            migrationBuilder.CreateIndex(
                name: "IX_hotel_bookings_Status",
                table: "hotel_bookings",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_hotel_bookings_UserId",
                table: "hotel_bookings",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tour_bookings_BookingCode",
                table: "tour_bookings",
                column: "BookingCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_tour_bookings_PaymentId",
                table: "tour_bookings",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_tour_bookings_ScheduleId",
                table: "tour_bookings",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_tour_bookings_Status",
                table: "tour_bookings",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_tour_bookings_TourId",
                table: "tour_bookings",
                column: "TourId");

            migrationBuilder.CreateIndex(
                name: "IX_tour_bookings_UserId",
                table: "tour_bookings",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_wishlists_UserId_ItemType_ItemId",
                table: "wishlists",
